...
const CollectionCard = ({ metaData, metaDataHash, collection }) => {
    ...
    return (<Link to={`/${collection?.contractAddress}/${collection?.metaDataHash}/${collection?.creator}`} class="w-96 h-64 m-8 bg-white rounded-lg shadow-lg overflow-hidden flex flex-col ">
