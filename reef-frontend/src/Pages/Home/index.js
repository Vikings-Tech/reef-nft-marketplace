...
const Home = () => {
    return (<div class="leading-normal tracking-normal text-indigo-400 bg-cover bg-fixed" style={{ "background": "radial-gradient(circle, rgba(26,22,84,1) 0%, rgba(35,35,120,1) 50%, rgba(68,18,107,1) 65%, rgba(54,0,103,1) 100%)" }}>
        <div class="h-full">
            <div class="w-full container mx-auto">
                <div class="w-full flex items-center justify-between">
                    <a class="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
                        Reef <span class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500">Marketplace</span>
                    </a>
